-- =====================================================
-- CATALYST EDUCATION - SUPABASE DATABASE SCHEMA
-- =====================================================
...
CREATE TABLE public.classes (
    id UUID DEFAULT uuid_generate_v4() PRIMARY KEY,
    name TEXT NOT NULL, -- e.g., "Grade 10A", "Form 3B"
    grade_level INTEGER NOT NULL CHECK (grade_level BETWEEN 1 AND 12),
    section TEXT, -- A, B, C, etc.
    subject TEXT, -- for subject-specific classes
...
CREATE TABLE public.student_assessments (
    ...
    grade TEXT, -- A, B, C, D, F or ECZ grades
    comments TEXT,
...
BEGIN
    INSERT INTO public.notifications (recipient_id, sender_id, type, title, message, data)
    VALUES (recipient_id, sender_id, notification_type, title, message, data)
...
BEGIN
    ...
    attendance_rate := (present_days::NUMERIC / total_days::NUMERIC) * 100;
...
-- Insert default school (can be updated later)
...
-- 1. Complete user management with profiles
-- 2. Educational structure (schools, classes, students)
-- 3. Lesson planning with ECZ alignment
-- 4. Comprehensive assessment system
-- 5. Detailed attendance tracking
